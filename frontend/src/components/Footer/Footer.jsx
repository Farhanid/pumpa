...
const Footer = () => {
    ...
    const socialLinks = [
        ...
        { icon: FaTwitter, href: 'https://twitter.com/pumpasquash', label: 'Twitter' },
        { icon: FaYoutube, href: 'https://youtube.com/@pumpasquash', label: 'YouTube' },
        { icon: FaLinkedin, href: 'https://linkedin.com/company/pumpasquash', label: 'LinkedIn' },
    ];
    ...
    return (
         ...
         <footer className="bg-gradient-to-br from-gray-50 via-white to-gray-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 border-t border-gray-200 dark:border-gray-800">
    <div className="max-w-7xl mx-auto px-6 lg:px-8 py-16">
        {/* Main Footer Grid */}
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-12 pb-12 border-b border-gray-200 dark:border-gray-800">
                    ...
                    {socialLinks.map((social, idx) => {
                        ...
                        return (
                            <a
                                ...
                                target="_blank"
                                rel="noopener noreferrer"
                                className="w-8 h-8 flex items-center justify-center rounded-full bg-gray-100 dark:bg-gray-800 text-gray-600 dark:text-gray-300 hover:bg-emerald-500 hover:text-white dark:hover:bg-emerald-500 transition-colors duration-200"
                                aria-label={social.label}
                            >
            ...
            <div className="space-y-5">
                ...
                <ul className="space-y-3 text-sm">
                    <li className="flex items-start gap-3 text-gray-600 dark:text-gray-300">
                        <FaMapMarkerAlt className="w-4 h-4 text-emerald-500 dark:text-emerald-400 mt-0.5 flex-shrink-0" />
                        <span>123 Sports Complex, Kuala Lumpur, Malaysia</span>
                    </li>
                    <li className="flex items-center gap-3 text-gray-600 dark:text-gray-300">
                        <FaPhone className="w-4 h-4 text-emerald-500 dark:text-emerald-400 flex-shrink-0" />
                        <a href="tel:+601111989375" className="hover:text-emerald-600 dark:hover:text-emerald-400 transition-colors">
                            +60 11-1198 9375
                        </a>
                    </li>
                    <li className="flex items-center gap-3 text-gray-600 dark:text-gray-300">
                        <FaEnvelope className="w-4 h-4 text-emerald-500 dark:text-emerald-400 flex-shrink-0" />
                        <a href="mailto:info@pumpasquash.com" className="hover:text-emerald-600 dark:hover:text-emerald-400 transition-colors">
                            info@pumpasquash.com
                        </a>
                    </li>
                    <li className="flex items-center gap-3 text-gray-600 dark:text-gray-300">
                        <FaClock className="w-4 h-4 text-emerald-500 dark:text-emerald-400 flex-shrink-0" />
            ...
            <div className="space-y-5">
                ...
                <div className="pt-4">
                    <a
                        href="/contact"
                        className="inline-flex w-full items-center justify-center px-4 py-2.5 text-sm font-medium text-white bg-emerald-600 dark:bg-emerald-500 rounded-md hover:bg-emerald-700 dark:hover:bg-emerald-600 transition-colors duration-200 shadow-sm hover:shadow-md"
                    >
                        Book Trial Class
                    </a>
                </div>
